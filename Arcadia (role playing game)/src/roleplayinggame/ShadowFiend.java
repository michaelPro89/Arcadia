 ...
 * @author M4K3L
 */
public class ShadowFiend extends Dires
{
    
     private final int FINAL_HEALTH = 33;
    ...
    private final String HERO_NAME = "Shadow Fiend";
    private final String SKILL_NAME = "Shadowraze";
    private final int SKILL_POWER = 13;
   private String heroDescription = " - steals the souls from units he kills. His skill ''Shadowraze'' razes the ground directly in front of him"
